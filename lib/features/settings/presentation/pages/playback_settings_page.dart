          ...
          return ListView(
            ...
            children: [
              ...
              SwitchListTile(
                ...
                title: const Text('Auto-Play Videos',
                    style: TextStyle(
                        ...
                        fontFamily: 'Poppins',
                        fontSize: 16)),
                subtitle: const Text('Play videos automatically when opened',
                    style: TextStyle(
                ...
                onChanged: (val) =>
                    context.read<SettingsBloc>().add(ToggleAutoPlay()),
              ...
              SwitchListTile(
                ...
                onChanged: (val) =>
                    context.read<SettingsBloc>().add(ToggleAutoPlayNext()),
                activeThumbColor: AppColors.colorPrimary,
                inactiveThumbColor: AppColors.colorTextMuted,
                inactiveTrackColor: AppColors.colorSurface3,
              ),
              SwitchListTile(
                ...
                onChanged: (val) =>
                    context.read<SettingsBloc>().add(ToggleLoopVideo()),
                activeThumbColor: AppColors.colorPrimary,
                inactiveThumbColor: AppColors.colorTextMuted,
                inactiveTrackColor: AppColors.colorSurface3,
              ),
              SwitchListTile(
                ...
                onChanged: (val) =>
                    context.read<SettingsBloc>().add(ToggleSubtitles()),
                activeThumbColor: AppColors.colorPrimary,
                inactiveThumbColor: AppColors.colorTextMuted,
                inactiveTrackColor: AppColors.colorSurface3,
              ),
