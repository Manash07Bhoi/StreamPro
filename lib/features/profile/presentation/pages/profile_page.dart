                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(
                          profile.displayName,
                          style: const TextStyle(fontFamily: 'Poppins', fontSize: 22, fontWeight: FontWeight.w600, color: Colors.white),
                        ),
                        ...
                        Row(
                          ...
                          children: [
                            _buildStatCard('Videos Watched', profile.totalWatchedVideos.toString()),
                            _buildStatCard('Watch Time', _formatWatchTime(profile.totalWatchTimeSeconds)),
                            _buildStatCard('Liked Videos', profile.totalLikes.toString()),
                          ],
                        ),
                        const SizedBox(height: 32),
                  ...
                  child: Column(
                    ...
                    children: [
                      const Padding(
                        ...
                        child: Text('Quick Links', style: TextStyle(fontFamily: 'Poppins', fontSize: 18, fontWeight: FontWeight.w600, color: Colors.white)),
                      ),
                      _buildListTile(context, Icons.playlist_play, 'My Playlists', () => context.push('/playlists')),
                      _buildListTile(context, Icons.download, 'My Downloads', () => context.push('/downloads')),
                      _buildListTile(context, Icons.favorite, 'Liked Videos', () => context.push('/liked')),
                      ...
                      const Padding(
                        padding: EdgeInsets.symmetric(horizontal: 24.0, vertical: 8.0),
                        child: Text('Account', style: TextStyle(fontFamily: 'Poppins', fontSize: 18, fontWeight: FontWeight.w600, color: Colors.white)),
                      ),
                      _buildListTile(context, Icons.settings, 'Settings', () => context.push('/settings')),
                      _buildListTile(context, Icons.help_outline, 'Help & FAQ', () => context.push('/help')),
                      _buildListTile(context, Icons.info_outline, 'About StreamPro', () => context.push('/about')),
