...
class _DiscoverViewState extends State<DiscoverView> {
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  hintStyle: const TextStyle(
                      color: AppColors.colorTextMuted, fontFamily: 'Poppins'),
                  ...
                  if (filterCount > 0)
                    Positioned(
                      ...
                      child: Container(
                        ...
                        child: Text(filterCount.toString(),
      ...
      builder: (context, state) {
        if (state is SearchResultsLoaded && state.filters.isActive) {
          ...
          if (filters.sortBy != 'relevant') {
            chips.add(_buildFilterChip(context, 'Sort: ${filters.sortBy}'));
          }
          if (filters.duration != 'any') {
            chips.add(
                _buildFilterChip(context, 'Duration: ${filters.duration}'));
          }
          for (var c in filters.categories) {
            chips.add(_buildFilterChip(context, c));
          }
          for (var r in filters.ratings) {
            chips.add(_buildFilterChip(context, r));
          }
  ...
  Widget _buildIdleState(
      BuildContext context, List<SearchHistoryEntry> recentSearches) {
    return ListView(
      ...
      children: [
          ...
          Wrap(
            ...
            children: recentSearches
                .map((entry) => InputChip(
                      ...
                      onDeleted: () => context
                          .read<SearchBloc>()
                          .add(RemoveSearchHistoryEntry(entry.id)),
                      onPressed: () {
                        _searchController.text = entry.query;
                        context
                            .read<SearchBloc>()
                            .add(SearchSubmitted(entry.query));
                      },
        ...
        GridView.count(
          ...
          children: const [
            _CategoryCardMock(
                title: 'Action',
                color1: AppColors.colorError,
                color2: AppColors.colorError,
                icon: Icons.flash_on),
            _CategoryCardMock(
                title: 'Comedy',
                color1: AppColors.colorWarning,
                color2: AppColors.colorWarning,
                icon: Icons.sentiment_very_satisfied),
            _CategoryCardMock(
                title: 'Drama',
                color1: AppColors.colorPrimary,
                color2: AppColors.colorSecondary,
                icon: Icons.theater_comedy),
            _CategoryCardMock(
                title: 'Documentary',
                color1: AppColors.colorSuccess,
                color2: AppColors.colorSuccess,
                icon: Icons.public),
          ],
        ),
        TextButton(
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const Text('Try different keywords or browse by category.',
              style: TextStyle(
                  fontFamily: 'Poppins',
                  fontSize: 14,
                  color: AppColors.colorTextSecondary)),
      ...
      builder: (bottomSheetContext) => Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Wrap(
              spacing: 8,
              children: ['Relevant', 'Views', 'Newest', 'Duration']
                  .map((e) => ChoiceChip(
                        label: Text(e),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: () {
                  // Apply logic here
                  searchBloc.add(SearchFiltersApplied(
                      const SearchFilters(sortBy: 'views')));
                  Navigator.pop(bottomSheetContext);
                },
